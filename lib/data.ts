...
export const FAQS: FAQ[] = [
  { q: "What makes Shreeji Marketers different from other agencies?", a: "We combine data science with creative strategy. Every campaign is built on real analytics, tested hypotheses, and transparent reporting. You get a dedicated team that treats your growth as their own — with zero vanity metrics, only business outcomes." },
  ...
  { q: "Can I get a free audit of my website or campaigns?", a: "Yes. We offer a complimentary SEO + marketing audit for qualified businesses. Our team reviews your site, current rankings, competitor landscape, and paid campaigns — then delivers a prioritized action plan. No strings attached." },
  { q: "What industries do you specialize in?", a: "We serve ecommerce D2C, real estate, healthcare, education, SaaS, fintech, hospitality, local businesses, and more. Every strategy is tailored to your industry's unique customer journey and competitive dynamics." },
